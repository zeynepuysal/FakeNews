...
import sys
sys.path.append("C:\\Users\\Gamze\\Downloads\\FakeNewsNet-master (1)\\FakeNewsNet-master\\FakeNewsNet-master\\code\\resource_server\\util")
from TwythonConnector import TwythonConnector
...
class DataCollector:
    ...
    def load_news_file(self, data_choice):
        ...
        news_list = []
        with open(os.path.dirname(__file__) + '/{}/{}_{}.csv'.format(self.config.dataset_dir, data_choice["news_source"],
